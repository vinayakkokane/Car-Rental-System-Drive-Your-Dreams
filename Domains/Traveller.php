        ...
        ?>
          ...
          <form action="../bookcar.php" method="post">
            ...
            ?>
              ...
              <td style="vertical-align:middle" align="center"> <button class="btn btn-dark text-light" style="font-size: 15px; font-weight:bold" name="<?php echo $rws['car_id']; ?>">Book Car</button>
              </td>
              </form>
            <?php
            } else {
